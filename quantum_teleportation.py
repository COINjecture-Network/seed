...
# Let's create a superposition state: |ψ⟩ = (1/√2)(|0⟩ + i|1⟩)
...
for outcome, count in counts.items():
    # In Qiskit, bit string is ordered c2,c1,c0 (left to right)
    # So outcome[0] is c2, which is the measurement result of q2 (the teleported qubit)
